...
//
//Texture_Mine fpsTimer_Texture, fpsCapTimer_Texture, fpsCapTimerPrompt_Texture;
//
...
//				printf("Failed to render text texture!\n");
//			}
//			if (!startupStuff->LoadText(gFont2, "22_timing/lazy.ttf", "Press R to Reset the Timer", { 255, 0, 0 }, 20, fpsCapTimerPrompt_Texture))
//			{
//				printf("Failed to render text texture!\n");
//			}
//#endif
...
//			//Frame Cap
//			Timer frameCapTimer;
//			std::stringstream fpsCapTimerText;
//
//			while (!quit)
//			{
//				frameCapTimer.start();
...
//				}
//
//				int frame_Ticks = frameCapTimer.getTicks();
